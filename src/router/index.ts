...
//     { path: '/who-we-are', component: () => import('@/views/WhoWeAreView.vue') },
//     { path: '/what-we-do', component: () => import('@/views/WhatWeDoView.vue') },
//     { path: '/services', component: () => import('@/views/ServicesView.vue') },
//     { path: '/artificial-intelligence', component: () => import('@/views/ArtificialIntelligenceView.vue') },
//     { path: '/case-studies', component: () => import('@/views/CaseStudiesView.vue') },
